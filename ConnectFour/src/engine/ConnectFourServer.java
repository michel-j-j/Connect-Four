...
public class ConnectFourServer {
    ...
    private static void handlePlayerTurn(BufferedReader input, PrintWriter output, PrintWriter otherPlayerOutput, ConnectFour game, char playerSymbol) throws IOException {
